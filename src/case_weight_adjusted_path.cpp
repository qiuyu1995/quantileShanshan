...
*/
arma::vec case_weight_adjusted_Empty_E(arma::vec a, arma::mat B, arma::vec c, arma::vec beta_w, arma::uvec L, arma::uvec R, int j_in_L, double lam) {
...
*/
	...
	while (w_m > 1e-6) {
		...
		if (E_size > 0) {
		    ...
		    E_empty_output = case_weight_adjusted_Empty_E(a, B, c, beta_w, L, R, j_in_L, lam);
